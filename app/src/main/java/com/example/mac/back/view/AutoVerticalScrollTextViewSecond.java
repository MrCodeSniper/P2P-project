 ...
 * 自动垂直滚动的TextView
 */
public class AutoVerticalScrollTextViewSecond extends TextSwitcher implements ViewSwitcher.ViewFactory {
    ...
    public AutoVerticalScrollTextViewSecond(Context context) {
        this(context, null);
    }

    public AutoVerticalScrollTextViewSecond(Context context, AttributeSet attrs) {
        super(context, attrs);
