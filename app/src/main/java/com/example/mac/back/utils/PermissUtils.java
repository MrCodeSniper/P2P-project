...
public class PermissUtils {
    ...
    public static boolean getPhoneStatePermissions(@NonNull Context activity, int requestCode) {
     ...
     * 是否拥有权限
     */
    public static boolean hasPermissons(@NonNull Context activity, @NonNull String... permissions) {
        if (!needCheckPermission()) {
            return true;
        }
        for (String permission : permissions) {
     ...
     */
    public static boolean deniedRequestPermissonsAgain(@NonNull Context activity, @NonNull String... permissions) {
        if (!needCheckPermission()) {
            return false;
        }
     ...
     */
    public static void startApplicationDetailsSettings(@NonNull Context activity, int requestCode) {
     ...
     * @return 是否已经获取权限
     */
    public static boolean requestPerssions(Context activity, int requestCode, String... permissions) {
        ...
        if (!hasPermissons(activity, permissions)) {
            if (deniedRequestPermissonsAgain(activity, permissions)) {
                ...
                if (deniedPermissions != null) {
                    Activity activity1=(Activity) activity;
                    ActivityCompat.requestPermissions(activity1, deniedPermissions.toArray(new String[deniedPermissions.size()]), requestCode);
